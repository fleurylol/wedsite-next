    ...
    <div className='flex flex-col justify-center m-auto p-2 item-center h-screen bg-blue-600'> 
      <div className='border rounded-3xl p-2'>
        <div className='text-slate-300'>
          ...
          <h6 className={`text-4xl font-bold text-center ${dancingScript.className}`}>at The Wagner House</h6>
          <h4 className={`text-2xl font-bold text-center ${libreBaskerville.className}`}>on 1/30/26</h4>
          <h6 className={`text-lg font-bold text-center ${libreBaskerville.className}`}>1 E Spring St Ste 4338, Freeport, IL</h6>
          <p className={`text-xs text-center ${libreBaskerville.className}`}>Please add name and each member of your party below</p>
        </div>
        <div className='flex items-center gap-2 p-4'> 
          <span className={`text-3xl font-bold ${dancingScript.className} text-slate-300 p2`}>The</span> 
          <Input placeholder='' className='' id="party" />
          <span className={`text-3xl font-bold ${dancingScript.className} text-slate-300 p2`}>Party</span> 
        </div>
        ...
        {!guest && ( <Button variant={"outline"} className="size-fit text-black rounded-lg p-2" onClick={()=>{addGuestDemo()}}>Add</Button>) }
